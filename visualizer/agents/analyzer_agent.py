"""
Analyzer Agent
Use MiniSWEAgent to analyze a benchmark and produce a JSON analysis.
"""
...
from visualizer.agents.prompt_mm import benchmark_analysis_prompt
...
class AnalyzerAgent:
    ...
    async def analyze(
        ...
        """
        Analyze a benchmark and write the JSON file.

        Args:
            benchmark_path: Benchmark folder path
        ...
        # Build task
        task = self._build_task(benchmark_path, output_file)
    ...
    def _build_task(self, benchmark_path: Path, output_file: Path) -> str:
        """Build the prompt for the agent."""

        return benchmark_analysis_prompt(benchmark_path, output_file)
